...
const German = () => {
    return (
      <>
       ...
       <Feature topheading="" heading="Erleben Sie luxuriöses Inselwohnen in Dubai" paragraph="Sunset Bay 2 by Imtiaz bietet ein exklusives Wohnkonzept auf den Dubai Islands, das moderne Eleganz mit idyllischer Küstenatmosphäre verbindet. Jedes Apartment verfügt über großzügige Terrassen, bodentiefe Fenster und einen spektakulären Blick auf das Wasser." cta="Melden Sie Ihr Interesse an"></Feature>
       </div>
       <Venice title="SUNSET BAY 2" paragraph="Treten Sie ein in eine Welt raffinierten Luxus, in der jedes Detail sorgfältig und perfekt ausgearbeitet ist. Küchen mit Miele-Ausstattung, Armaturen von Gessi und Oberflächen von Villeroy & Boch werten Ihr alltägliches Wohnerlebnis auf. Diese Residenzen sind mit offenem Grundriss gestaltet, in natürliches Licht getaucht und bieten luxuriöse Schlafzimmer, Badezimmer im Spa-Stil und großzügige Wohnräume für ultimativen Komfort."></Venice>   
    
       <Amenities title="Exklusive Annehmlichkeiten" first="Freiluftkino" secend="Wasser-Lounges" third="Private Whirlpools" four="Kinderspielplatz" five="Yoga-Platz im Freien" six="Private Terrassen" seven="Clubhaus & Fitnessstudio" eight="Grill- und Essbereiche" nine="Sunken lounges" ten="schwimmende Inseln"></Amenities>
